...
% 设置目录深度：1表示只显示到section级别，subsection有编号但不在目录中显示
...
\include{body/2.TheoreticalFoundation}
\include{body/3.TIA}
\include{body/4.MIA}
\include{body/5.Result}
\backmatter
\include{back/conclusion}   % 结论
% \bibliographystyle{gbt7714-numerical}  % 按作者-年份排序
\bibliographystyle{gbt7714-numerical-quanjiao} % 全角标点的国标要求的参考文献样式(按引用顺序), 哈尔滨硕博用这个
...
% 硕博书序
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\bibliography{reference,intro_references,Grad} % 参考文献
% \begin{appendix}%附录
% \input{back/appA.tex}
% \end{appendix}
