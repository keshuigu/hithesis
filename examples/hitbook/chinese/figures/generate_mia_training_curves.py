...
# 确保 PDF/EPS 使用 Type42 (避免位图或缺字问题)
...
ax1.plot(epochs, total_loss, 'k-', linewidth=2.5, label='总损失', zorder=10)
ax1.plot(epochs, weighted_prior, linewidth=1.2, label='加权先验', alpha=0.7, linestyle='--')
ax1.plot(epochs, weighted_perc, linewidth=1.2, label='加权感知', alpha=0.7, linestyle='--')
ax1.plot(epochs, lambda_schedule * weighted_cls, linewidth=1.2, label='λ·加权分类', alpha=0.7, linestyle=':')
ax1.set_xlabel('Epoch')
ax1.set_ylabel('Loss Value')
ax1.set_title('(a) 总损失与加权分项', fontsize=11, fontweight='bold')
...
ax2.plot(epochs, prior_loss_raw, linewidth=1.8, label='先验损失', color='#1f77b4')
ax2.plot(epochs, perc_loss_raw, linewidth=1.8, label='感知损失', color='#ff7f0e')
ax2.plot(epochs, cls_loss_raw, linewidth=1.8, label='分类损失', color='#2ca02c')
ax2.plot(epochs, preg_loss_raw, linewidth=1.8, label='特征中心正则损失', color='#d62728')
ax2.plot(epochs, id_loss_raw, linewidth=1.8, label='身份一致性损失', color='#9467bd')
ax2.plot(epochs, reg_loss_raw, linewidth=1.8, label='正则化损失', color='#8c564b')
ax2.set_xlabel('Epoch')
ax2.set_ylabel('Loss Value')
ax2.set_title('(b) 原始分项损失（未加权）', fontsize=11, fontweight='bold')
...
ax3_twin.plot(epochs, knn_dist, linewidth=2, label='KNN 距离（0.7165）', color='#9467bd', marker='o', markersize=2, markevery=30)
ax3.set_xlabel('Epoch')
ax3.set_ylabel('FID 分数', color='#2ca02c')
ax3_twin.set_ylabel('KNN 距离', color='#9467bd')
ax3.tick_params(axis='y', labelcolor='#2ca02c')
ax3_twin.tick_params(axis='y', labelcolor='#9467bd')
ax3.set_title('(c) 生成质量指标', fontsize=11, fontweight='bold')
...
ax4.plot(epochs, target_acc, linewidth=2, label='目标准确率（94.87%）', color='#1f77b4', marker='d', markersize=2, markevery=30)
ax4.plot(epochs, eval_acc, linewidth=2, label='评估集准确率（83.15%）', color='#ff7f0e', marker='s', markersize=2, markevery=30)
ax4.set_xlabel('Epoch')
ax4.set_ylabel('Accuracy (%)')
ax4.set_title('(d) 分类准确率', fontsize=11, fontweight='bold')
...
ax5.plot(epochs, uncertainty_prior, linewidth=2, label=r'先验 $\sigma_{prior}$', color='#1f77b4')
ax5.plot(epochs, uncertainty_perc, linewidth=2, label=r'感知 $\sigma_{perc}$', color='#ff7f0e')
ax5.plot(epochs, uncertainty_cls, linewidth=2, label=r'分类 $\sigma_{cls}$', color='#2ca02c')
ax5.plot(epochs, uncertainty_preg, linewidth=2, label=r'特征正则 $\sigma_{preg}$', color='#d62728')
ax5.plot(epochs, uncertainty_id, linewidth=2, label=r'身份 $\sigma_{id}$', color='#9467bd')
ax5.plot(epochs, uncertainty_reg, linewidth=2, label=r'正则 $\sigma_{reg}$', color='#8c564b')
ax5.axhline(y=1.0, color='gray', linestyle='--', linewidth=1.5, alpha=0.6, label='初始 σ=1.0')
ax5.set_xlabel('Epoch')
ax5.set_ylabel(r'不确定度 $\sigma$')
ax5.set_title(r'(e) 任务不确定性参数 $\sigma$', fontsize=11, fontweight='bold')
...
ax6.plot(epochs, weight_prior, linewidth=2, label=r'先验权重 $1/(2\sigma_{prior}^2)$', color='#1f77b4')
ax6.plot(epochs, weight_perc, linewidth=2, label=r'感知权重 $1/(2\sigma_{perc}^2)$', color='#ff7f0e')
ax6.plot(epochs, weight_cls, linewidth=2, label=r'分类权重 $1/(2\sigma_{cls}^2)$', color='#2ca02c')
ax6.plot(epochs, weight_preg, linewidth=2, label=r'特征正则权重 $1/(2\sigma_{preg}^2)$', color='#d62728')
ax6.plot(epochs, weight_id, linewidth=2, label=r'身份权重 $1/(2\sigma_{id}^2)$', color='#9467bd')
ax6.plot(epochs, weight_reg, linewidth=2, label=r'正则权重 $1/(2\sigma_{reg}^2)$', color='#8c564b')
ax6.set_xlabel('Epoch')
ax6.set_ylabel(r'权重 $1/(2\sigma^2)$')
ax6.set_title(r'(f) 任务权重 $1/(2\sigma^2)$', fontsize=11, fontweight='bold')
